...
class Parser {
  ...
  private Stmt classDeclaration() {
    ...
    consume(LEFT_BRACE, "Expect 0027{0027 before class body.");
    ...
    consume(RIGHT_BRACE, "Expect 0027}0027 after class body.");
  ...
  private Stmt traitDeclaration() {
    ...
    consume(LEFT_BRACE, "Expect 0027{0027 before trait body.");
    ...
    consume(RIGHT_BRACE, "Expect 0027}0027 after trait body.");
