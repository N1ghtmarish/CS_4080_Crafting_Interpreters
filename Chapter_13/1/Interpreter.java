...
class Interpreter implements Expr.Visitor<Object>,
  ...
  // Challenge 13.1: compose methods from a list of applied traits.
  private Map<String, LoxFunction> applyTraits(List<Expr> traits) {
    ...
    for (Expr traitExpr : traits) {
      ...
      if (!(traitObject instanceof LoxTrait)) {
        Token traitName = ((Expr.Variable) traitExpr).name;
        throw new RuntimeError(traitName,
            "'" + traitName.lexeme + "' is not a trait.");
      }
